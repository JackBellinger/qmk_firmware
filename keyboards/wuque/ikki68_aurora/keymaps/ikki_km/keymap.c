...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_all(
		...
		TD(CTRL), KC_LGUI, TD(ALT), KC_NO, KC_SPC, KC_NO, SC_RAPC, MO(1), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
	),						   //space		  space
	[1] = LAYOUT_all(
		QK_BOOT, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, QK_LEAD, KC_DEL, RGB_TOG, _______,
		_______, _______, _______, _______, _______, TD(TIMER), _______, _______, _______, _______, _______, _______, _______, KC_WSCH, TD(MACRO), _______,
